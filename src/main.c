...
static const struct applet applets[] = {
    ...
    {"mkfifo", bx_mkfifo_main},     {"mknod", bx_mknod_main},     {"mktemp", bx_mktemp_main},   {"touch", bx_touch_main},   {"truncate", bx_truncate_main}, {"shred", bx_shred_main},
    {"install", bx_install_main},   {"cp", bx_cp_main},           {"mv", bx_mv_main},           {"wget", bx_wget_main},     {"expr", bx_expr_main},         {"md5sum", bx_md5sum_main},
    {"base64", bx_base64_main},     {"true", bx_true_main},       {"false", bx_false_main},
};
