...
typedef enum {
    ...
    BX_FETCH_NET_TARGET_TLS_POLICY,
 ...
 * boundary: its callback runs after the terminal reply, while the payload is
 * still private and before writer close. writer is borrowed and must not be
