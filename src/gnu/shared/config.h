...
/* Define to 1 when the gnulib module openat2 should be tested. */
#define GNULIB_TEST_OPENAT2 1
...
#define PACKAGE_STRING "GNU tar 1.35.90"
...
#define PACKAGE_VERSION "1.35.90"
