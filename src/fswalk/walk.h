...
enum bx_walk_counter {
    ...
    BX_WALK_COUNTER_GETDENTS64_CALLS,
    BX_WALK_COUNTER_GETDENTS64_BYTES,
    ...
    BX_WALK_COUNTER_STAT_REASON_MAX_FILESIZE,
    BX_WALK_COUNTER_STAT_REASON_MIN_FILESIZE,
    BX_WALK_COUNTER_STAT_REASON_TYPE,
    BX_WALK_COUNTER_STAT_REASON_SORT,
    ...
    BX_WALK_COUNTER_PATH_PUSH_CALLS,
    BX_WALK_COUNTER_PATH_PUSH_NS,
    BX_WALK_COUNTER_PATH_POP_CALLS,
    BX_WALK_COUNTER_PATH_POP_NS,
    BX_WALK_COUNTER_PATH_ALLOCS,
    BX_WALK_COUNTER_PATH_COPIES_BEFORE_MATCH,
    BX_WALK_COUNTER_DIR_BUCKET_TINY_DIRS,
    BX_WALK_COUNTER_DIR_BUCKET_TINY_ENTRIES,
    BX_WALK_COUNTER_DIR_BUCKET_TINY_NS,
    BX_WALK_COUNTER_DIR_BUCKET_SMALL_DIRS,
    BX_WALK_COUNTER_DIR_BUCKET_SMALL_ENTRIES,
    BX_WALK_COUNTER_DIR_BUCKET_SMALL_NS,
    BX_WALK_COUNTER_DIR_BUCKET_MEDIUM_DIRS,
    BX_WALK_COUNTER_DIR_BUCKET_MEDIUM_ENTRIES,
    BX_WALK_COUNTER_DIR_BUCKET_MEDIUM_NS,
    BX_WALK_COUNTER_DIR_BUCKET_HUGE_DIRS,
    BX_WALK_COUNTER_DIR_BUCKET_HUGE_ENTRIES,
    BX_WALK_COUNTER_DIR_BUCKET_HUGE_NS,
};
...
enum bx_walk_metadata_reason {
    ...
    BX_WALK_METADATA_REASON_MAX_FILESIZE,
    BX_WALK_METADATA_REASON_MIN_FILESIZE,
    BX_WALK_METADATA_REASON_TYPE,
    BX_WALK_METADATA_REASON_SORT,
