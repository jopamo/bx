...
enum bx_search_walk_counter {
    ...
    BX_SEARCH_WALK_IGNORE_BASENAME_ONLY_FAST_PATHS,
    BX_SEARCH_WALK_IGNORE_NO_GENERIC_GLOB_FAST_PATHS,
    BX_SEARCH_WALK_IGNORE_BUILTIN_CHECKS,
    BX_SEARCH_WALK_IGNORE_BUILTIN_REJECTS,
    BX_SEARCH_WALK_IGNORE_GITIGNORE_CHECKS,
    BX_SEARCH_WALK_IGNORE_GITIGNORE_REJECTS,
    BX_SEARCH_WALK_IGNORE_DOTIGNORE_CHECKS,
    BX_SEARCH_WALK_IGNORE_DOTIGNORE_REJECTS,
    ...
    BX_SEARCH_WALK_FILTER_HIDDEN_POLICY_CHECKS,
    BX_SEARCH_WALK_FILTER_HIDDEN_POLICY_REJECTS,
