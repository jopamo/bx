#ifndef BX_APPLETS_ARCHIVE_ARCHIVE_XZ_H
#define BX_APPLETS_ARCHIVE_ARCHIVE_XZ_H
...
struct bx_archive_xz_stream_sink {
    void* user;
    bool (*write)(void* user, const void* data, size_t len);
};

typedef bool (*bx_archive_xz_stream_producer_fn)(void* user,
