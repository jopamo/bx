 ...
 */
#include "feature.h"
#include "bx_vim_feature_overrides.h"

/*
 * bx links multiple applets into one binary.  A small number of Vim global
 * symbols collide with other applets, so keep the embedded editor namespace
 * local to the Vim import boundary.
 */
#define do_source bx_vim_do_source
#define last_window bx_vim_last_window
